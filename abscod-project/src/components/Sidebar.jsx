              ...
              >
                <div className="flex items-center justify-between w-full">
                  ...
                  >
                    ...
                    <span className="text-sm ml-2 leading-none">Promos</span>
                  </a>
                </div>
              </li>
              <li
                  ...
                  <ul id="list" className=" text-sm mt-3  leading-none w-full">
                    ...
                    <NavLink to="/addsale">
                      ...
                      <li
                        ...
                        onclick="dropdownHandler(this)"
                      >
                        <div className="flex items-center justify-between w-full" onClick={()=>setPurchaseShow(!purchaseShow)}>
                          <a
                            href="javascript:void(0)"
                            className="flex items-center rounded focus:outline-none focus:ring-2 focus:ring-white"
                          >
                  ...
                  <ul id="list" className=" text-sm mt-3  leading-none w-full">
                    ...
                    <NavLink to="/addpurchase">
                      ...
                      <li
                        ...
                        onclick="dropdownHandler(this)"
                      >
                        <div className="flex items-center justify-between w-full" onClick={()=>setReturnShow(!returnShow)}>
                          <a
                            href="javascript:void(0)"
                            className="flex items-center rounded focus:outline-none focus:ring-2 focus:ring-white"
                          >
