                    ...
                    <div className="1xl:container 2xl:mx-auto">
                        <nav className>
                            <div className=" flex flex-row justify-between">
                                <div className=" flex space-x-3 items-center py-2 lg:pl-7 sm:pl-6  pl-4 pr-8">
                                ...
                                <div className=" hidden sm:flex justify-end flex-row lg:pr-7 sm:pr-6 py-6 pr-4 pl-8">
                                   <div className="flex  px-28 ">
                                    <NavLink to='/pos' className='border-2 px-10 py-2 text-white bg-blue-500 rounded text-lg'>POS</NavLink>
                                   </div>
                                    <div className=" flex justify-center items-center flex-row">
                                        <img className="w-10 h-10 " src="https://i.ibb.co/QMddNDb/Ellipse-14.png" alt="individual person image-3" />
                                        <div className="ml-2">
                                            <p className="text-lg leading-4 font-semibold text-gray-800">{data.name}</p>
                                            <p className=" font-normal text-xs leading-3 text-gray-600 mt-1">{data.email}</p>
                                        </div>
                                ...
                                {/* Burger Icon */}
                                <div id="bgIcon"  className=" focus:outline-none focus:ring focus:ring-offset-2 focus:ring-gray-800 block sm:hidden cursor-pointer lg:pr-7 sm:pr-6 py-6 pr-4">
